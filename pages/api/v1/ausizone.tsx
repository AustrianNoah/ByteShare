...
export default async function handler(req: NextRequest) {
    try {
        ...
        const title = searchParams.get("title") ?? "AusiZone";
        const subtitle = searchParams.get("subtitle"!) ?? "Join Now and get into the AusiUnity!";
        ...
        return new ImageResponse(
            <div tw='w-[1200px] h-[240px] flex flex-col items-center justify-center text-center'>
