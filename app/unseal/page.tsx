        ...
        <div className="max-w-4xl mx-auto">
          {remainingReads !== null ? (
            <div className="text-sm text-center text-zinc-600">
              {remainingReads > 0 ? (
                <p>
                  Dieses Dokument kann <span className="text-zinc-100">{remainingReads}</span>x mal gelesen & oder angesehen werden.
                </p>
              ) : (
                <p className="text-zinc-400">
                  Das war nun die letzte Ansicht dieses Dokuments, <span color="red">Lade neu und das Dokument wird gelöscht sein!</span>
                </p>
              )}
            </div>
          ) : null}
