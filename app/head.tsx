export default function Head({ title, subtitle }: { title: string; subtitle: string }) {
  ...
  const baseUrl = process.env.VERCEL_URL ? `https://byteshare.tf` : "http://localhost:3000";

  const url = new URL("/api/v1/dimage", baseUrl);
  ...
  return (
    <>
      ...
      <meta name="keywords" content="ByteShare, secure, secrets, share, environment, variables" />
